...
import {WRAPPER, HEADER, ADD_BUTTON, STATS_GRID, STATS, STAT_CARD, ICON_WRAPPER, VALUE_CLASS, LABEL_CLASS, FILTER_WRAPPER, FILTER_LABELS, SELECT_CLASSES, FILTER_OPTIONS, TABS_WRAPPER, TAB_BASE, TAB_ACTIVE, TAB_INACTIVE, EMPTY_STATE} from '../assets/dummy'
import { HomeIcon, Plus, Icon, Filter, Calendar, CalendarIcon } from 'lucide-react'
...
const stats= useMemo(()=>({
  ...
  medumPriority: tasks.filter(t=> t.priority?.toLowerCase() === 'medium').length,
