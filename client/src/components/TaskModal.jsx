...
import { baseControlClasses, DEFAULT_TASK, layoutClasses, priorityStyles } from '../assets/dummy'
             ...
             <form onSubmit={handleSubmit} className=' space-y-4' >
                  ...
                  <div>
                    ...
                    <div className=' flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200'>
                            <input type='text' name='title' required value={taskData.title} onChange={handleChange} className='w-full focus:outline-none text-sm' 
