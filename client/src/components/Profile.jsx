...
const API_URL="https://task-manager-g67m.onrender.com"
...
const Profile = ({setCurrentUser, onLogout}) => {
    ...
    const saveProfile= async (e) =>{
        ...
        {
            toast.error(err.response?.data?.message || "Profile update faild")
        }
    }
    ...
    const changePassword= async(e)=>{
         ...
         {
          toast.error(err.response?.data?.message || "Password change faild")
         }
    }
    ...
    <div className=' min-h-screen bg-gray-50'>
       ...
       <div className=' max-w-4xl mx-auto p-6'>
              ...
              <div className=' flex items-center gap-4 mb-8'>
                   <div className=' w-16 h-16 rounded-full bg-gradient-to-br text-white from-fuchsia-500 to-purple-600 flex items-center justify-center text-2xl font-bold shadow-md'>
