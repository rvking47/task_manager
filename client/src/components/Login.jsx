...
const Login = ({onSubmit, onSwitchMode}) => {
    const [showPassword, setShowPassword] = useState(false);
     ...
     const url='https://task-manager-g67m.onrender.com'
     ...
     const handleSubmit= async(e)=>{
      ...
      try{
           ...
           if(!formData) throw new Error(data.message || "Login failed")
    ...
    <div className='max-w-md bg-white w-full shadow-lg border border-purple-100 rounded-xl p-8'>
         ...
         <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              <div className='flex items-center'>
                  ...
                  <label htmlFor='remembreMe' className='ml-2 block text-sm text-gray-700'>Remember Me</label>
              </div>
